...
// add selected product to offer
const addProduct = async () => {
  if (!newProductId.value) {
    return;
  }
  const success = await offersStore.addOfferProduct(newProductId.value, newProductQty.value);
  // reset inputs only on successful addition
  if (success) {
