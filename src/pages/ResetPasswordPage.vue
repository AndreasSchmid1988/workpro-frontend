      ...
      >
        <q-card-section class="q-px-lg">
          ...
          <div style="font-size: 23px" class="row q-mt-lg text-weight-medium">
            {{ $t('changePasswordCaption') }}
          </div>
          <div
            style="color: #697a8d; font-size: 15px"
            class="text-caption q-mt-xs"
          >
            {{ $t('passwordRestInstructions') }}
          </div>
        </q-card-section>
        <q-card-section>
          <div class="q-px-sm">
            <AccountCredentialsResetForm></AccountCredentialsResetForm>
          </div>
          <div class="row q-px-sm">
            <q-btn
              :loading="authStore.loading"
              class="q-mt-lg full-width"
              :label="$t('passwordResetSumbitButton')"
...
import AccountCredentialsResetForm from 'components/account/AccountCredentialsResetForm.vue';
